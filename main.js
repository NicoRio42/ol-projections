...
layers['wmts2154'] = new TileLayer();
const url2154 = "https://wxs.ign.fr/lambert93/geoportail/wmts?SERVICE=WMTS&VERSION=1.0.0&REQUEST=GetCapabilities";
console.log(url2154)
fetch(url2154)
  ...
  .then(function (text) {
    ...
    options.wrapX = false;
    layers['wmts2154'].setSource(new WMTS(options));
  });
